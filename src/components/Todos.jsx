...
import { removeTodo, toggleEdit, updateTodo } from '../features/todoSlice'

const Todos = () => {

    // yaha state todos wala array aajayega humare paas
    // har individual state me task and id dono hai
    let todosArray = useSelector(state => state.todos)
    todosArray = todosArray.filter(todo => todo.task != "Do not add this")
        ...
        <div className="text-white w-[50%]">
            ...
            <ul className="list-none">
                {todosArray.map((todo) => (
                    ...
                    >
                        <button
                            className='text-white text-sm font-medium hover:transform hover:scale-110 duration-200 ease-in-out tracking-wider'
                            onClick={() => {
